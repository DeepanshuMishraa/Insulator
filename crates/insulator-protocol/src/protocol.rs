...
pub const DAEMON_TOKEN_ENV: &str = "INSULATOR_DAEMON_TOKEN";
pub const DAEMON_ADDRESS_ENV: &str = "INSULATOR_DAEMON_ADDRESS";
pub const APP_EXECUTABLE_ENV: &str = "INSULATOR_APP_EXECUTABLE";
