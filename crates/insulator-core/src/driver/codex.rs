...
mod tests {
    ...
    fn computer_use_command_configuration_follows_the_setting() {
        ...
        assert!(
            !enabled_arguments
                .iter()
                .any(|argument| argument.contains("mcp_servers.insulator_computer_use"))
        );
        assert!(
            enabled_arguments
                .iter()
                .any(|argument| argument.contains("mcp_servers.insulator_js_repl.command"))
        );
        assert!(
            enabled_arguments
                .iter()
                .any(|argument| { argument == "mcp_servers.insulator_js_repl.args=[]" })
        );
        assert!(
            enabled_arguments
                .iter()
