...
const MAIN_PANEL_MIN_WIDTH: f32 = 440.0;
...
pub struct Insulator {
    ...
    pull_requests_page_error: Option<String>,
    pull_requests_refresh_queued: bool,
    ...
    pub fn new(
        ...
        let entity = cx.new(|cx| {
            ...
            Self {
                ...
                pull_requests_page_error: None,
                pull_requests_refresh_queued: false,
