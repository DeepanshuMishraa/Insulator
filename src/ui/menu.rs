...
const MENU_CONTEXT: &str = "InsulatorMenu";
...
const PANEL_FIELD_CONTEXT: &str = "InsulatorMenu > TextInput";
...
fn render_menu_item(
    ...
    match item {
        ...
        MenuItem::Submenu {
            ...
            // Insulator currently exposes one flyout level. Keeping a nested
