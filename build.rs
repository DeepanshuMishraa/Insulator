...
fn export_sparkle_public_key() {
    ...
    println!("cargo:rustc-env=INSULATOR_SPARKLE_PUBLIC_ED_KEY={value}");
}
...
fn embed_windows_resources() {
    ...
    // VERSIONINFO wants four numeric fields; Insulator's version has three.
...
BEGIN
    ...
    BEGIN
        BLOCK "040904b0"
        BEGIN
            VALUE "CompanyName", "Insulator\0"
            VALUE "FileDescription", "{description}\0"
            VALUE "FileVersion", "{package_version}\0"
            VALUE "InternalName", "insulator\0"
            VALUE "OriginalFilename", "insulator.exe\0"
            VALUE "ProductName", "Insulator\0"
...
"#
    ...
    let script = out_dir.join("insulator.rc");
